...
public class NonParticipatingTckResource {
    public static final String TCK_NON_PARTICIPANT_RESOURCE_PATH = "nonparticipatingtckresource";

    public static final String START_AND_END_PATH = "/startandend";
    public static final String START_BUT_DONT_END_PATH = "/startdontend";
    public static final String START_AND_END_NESTED_PATH = "/startnestedandend";

    public static final String START_BUT_DONT_END_NESTED_PATH = "/startnestedanddontend";
    ...
    public static final String STAUS_CODE_QUERY_NAME = "Coerce-Status";
    public static final String START_LRA_VIA_REMOTE_INVOCATIOM = "/startViaRemoteInvocation";
    ...
    public Response startAndEndLRA(@HeaderParam(LRA_HTTP_HEADER) String lraId,
                                   @DefaultValue("200") @QueryParam(STAUS_CODE_QUERY_NAME) int coerceStatus) {
    ...
    private String invokeRestEndpoint(String lra, String basePath, String path, int coerceResponse) {
        ...
        String lra2 = new LRAClientOps(target).invokeRestEndpointAndReturnLRA(lra, basePath, path, coerceResponse);
