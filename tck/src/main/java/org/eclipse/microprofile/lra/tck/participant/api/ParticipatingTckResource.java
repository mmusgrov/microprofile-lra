...
public class ParticipatingTckResource {
    ...
    public static final String TCK_PARTICIPANT_RESOURCE_PATH = "participatingTCKResource";
    public static final String JOIN_WITH_EXISTNG_LRA_PATH = "/joinWithExistingLRA";
    public static final String JOIN_WITH_NEW_LRA_PATH = "/joinWithNewLRA";
    public static final String COMPLETED_CNT_PATH = "/completedcount";
    public static final String COMPENSATED_CNT_PATH = "/compensatedcount";
